...
class Employ6 extends Component {
  state = {
    employees: [
  ...
  render() {
    ...
    const managers = employees.filter(e => e.designation === "Manager");
    return (
      <div className="container mt-4">
        <h2 className="mb-3">Managers</h2>
        {this.displayTable(managers)}
      </div>
    );
  }
}

export default Employ6;