...
class Employ4 extends Component {
  state = {
    employees: [
  ...
  render() {
    ...
    const sortedBySalary = employees1.sort((a, b) => a.salary - b.salary);
    return (
      <div className="container mt-4">
        <h2 className="mb-3">Employees Sorted by Salary (Ascending)</h2>
        {this.displayTable(sortedBySalary)}
      </div>
    );
  }
}

export default Employ4;