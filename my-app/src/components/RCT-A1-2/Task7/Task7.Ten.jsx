...
class Employ8 extends Component {
  state = {
    employees: [
  ...
  render() {
    ...
    const sortedByLevel = employees1.sort((a, b) => b.level - a.level);
    return (
      <div className="container mt-4">
        <h2 className="mb-3">Employees Sorted by Level (Descending)</h2>
        {this.displayTable(sortedByLevel)}
      </div>
    );
  }
}

export default Employ8;