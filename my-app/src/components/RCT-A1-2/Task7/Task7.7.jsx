...
class Employ5 extends Component {
  state = {
    employees: [
  ...
  render() {
    ...
    const techEmployees = employees.filter(e => e.dept === "Tech");
    return (
      <div className="container mt-4">
        <h2 className="mb-3">Tech Department Employees</h2>
        {this.displayTable(techEmployees)}
      </div>
    );
  }
}

export default Employ5;