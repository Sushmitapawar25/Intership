...
class Employ7 extends Component {
  state = {
    employees: [
  ...
  render() {
    ...
    const filtered = employees.filter(e => e.level > 1);
    return (
      <div className="container mt-4">
        <h2 className="mb-3">Employees with Level Greater than 1</h2>
