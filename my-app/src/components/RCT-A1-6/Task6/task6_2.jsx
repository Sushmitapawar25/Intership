...
class LeftPanel62 extends Component {
    ...
    render() {
        ...
        return (
            <div className="container">
                ...
                {this.showCheckboxes("Categories", optionsArray.categories, "selectedCategories", optionsSel.selectedCategories)}
            </div>
        );
    }
