...
class WorkStudyForm1 extends Component {
    state = {
        working: false,
        studying: false,
        companyName: "",
    ...
    handleSubmit = () => {
        ...
        let msg = "";
        if (working) msg += `Company: ${companyName}, Designation: ${designation}\n`;
        if (studying) msg += `College: ${collegeName}, Course: ${course}`;
        alert(msg || "No details filled");
    };
