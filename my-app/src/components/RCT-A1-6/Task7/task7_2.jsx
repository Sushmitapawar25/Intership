...
class LeftPanel72 extends Component {
    ...
    render() {
        ...
        return (
            <div className="container">
                ...
                {this.showRadios("Categories", optionsArray.categories, "selectedCategory", optionsSel.selectedCategory)}
            </div>
        );
    }
