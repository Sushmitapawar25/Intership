...
import LeftPanel71 from "./task7_1";
...
class Task71 extends Component {
    state = {
        optionsArray: {
    ...
    handleClear = () => {
        let s1 = { ...this.state };
        s1.optionsSel = { selectedProduct: "" };
        this.setState(s1);
    };

    showProducts = () => {
        const { selectedProduct } = this.state.optionsSel;
    ...
    render() {
        ...
        return (
            <div className="container mt-4">
                <h4 className="mb-3 text-primary">Product Names Radio</h4>
                <div className="row">
