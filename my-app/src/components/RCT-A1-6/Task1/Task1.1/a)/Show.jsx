/* If the country is selected, show a dropdown to 
   select the city.
   Note that the city dropdown should have cities based on the
   chosen country.

   If the passport is checked, show an input field 
   to enter the passport  number.
*/
...
class Show extends Component{
    ...
    render() {
        let {name,age, country,gender,passport,license,city,passportNumber} = this.state.person;
