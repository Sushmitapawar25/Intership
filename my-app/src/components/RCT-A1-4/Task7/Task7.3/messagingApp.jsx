...
import MessagingFolder2 from './messagingFolder';
import Message1 from './Message';
import NavBar from './NavBar1';

class MessagingApp2 extends Component {
  state = {
    folder: "All",
    selectedId: null,
    messages: [
      ...
      {
        id: 158, sent: false,
        from: "email@facebook.com", to: "jack@test.com",
      ...
      {
        id: 177, sent: true,
        from: "jack@test.com", to: "williams@test.com",
      ...
      {
        id: 179, sent: false,
        from: "williams@test.com", to: "jack@test.com",
      ...
      {
        id: 194, sent: false,
        from: "retweet@twitter.com", to: "jack@test.com",
        subject: "Your tweet has been retweeted by Thomas",
        text: "Your tweet on the Marvel Superheroes and Avengers has been retweeted by Thomas. It has now 41 retweets and 27 likes.",
        folder: "Social", read: false
      },
      {
        id: 204, sent: true,
  ...
  setFolder = (folder) => {
    this.setState({ folder, selectedId: null });
  }
  ...
  render() {
    ...
    return (
      <React.Fragment>
        <NavBar total={total} unread={unread} />
          ...
          <div className="row">
            <div className="col-2 bg-dark">
              ...
              {["All", "Inbox", "Social", "Sent"].map((f, index) => (
                <div
                  key={index}
                  className={"row border m-1 " + (folder === f ? "bg-primary text-white" : "bg-light")}
