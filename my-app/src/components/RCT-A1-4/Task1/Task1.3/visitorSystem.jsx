/* In a visitor system,max of 2 visitors are allowed inside.
   The status of a visitor can be Inside, Waiting or Outside.
   .Outside - click a button to enter. If there is a vacancy inside
              the visitor can enter, otherwise is added to queue.
   .Inside - click a button to exit.If there is a queue,the neext visitor
               is allowed inside.
    Use 2 COmponents - VisitorSystem & Visitor
*/
