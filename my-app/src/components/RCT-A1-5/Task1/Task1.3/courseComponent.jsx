/* Create a course with the fields name, faculty name,
   number of lectures. Display it in a table with edit and delete.

   In a course, students enroll.Show the count of students in the
   table.When the count of students is clicked,show
...
import CourseForm from "./courseFolder";
...
class CourseComponent extends Component {
    ...
    showCourseDetails = () =>{
        ...
        return (
            <div className="container">
                ...
                <button className="btn btn-primary mt-2" onClick={() => this.showCourseList()}>Show List of Courses</button>
            </div>
        );
    };
    ...
    render() {
        ...
        return view === 0 ? (
            <div className="container mt-5">
                {courses.map((c1,index) => (
                    ...
                    <div className="col-3 border">
                        <button className="btn btn-warning btn-sm mr-2" onClick={() => this.editCourse(index)}>Edit</button>&nbsp;&nbsp;
                        <button className="btn btn-danger btn-sm mr-2" onClick={() => this.deleteCourse(index)}>Delete</button>
                        </div>
                    </div>
                ))}<br/>
            ...
            <CourseForm course={editCourseIndex>=0 ? courses[editCourseIndex] : course} onSubmit={this.handleCourse}
